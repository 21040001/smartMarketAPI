...
public interface DALProductInterface extends JpaRepository<ProductsObject, Long> {
	...
	Optional<ProductsObject> findByStoreIdAndBarcode(@Param("storeId") String storeId,
	...
	void updateMonthFoyda(@Param("storeId") String storeId, @Param("barcode") String barcode,
	...
	List<ProductsObject> findByPriceRange(@Param("minPrice") String minPrice, @Param("maxPrice") String maxPrice);
}
